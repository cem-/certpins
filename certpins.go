...
const foot = `
    ...
    <br />
    <div id="footer">Copyright &copy; 2012 <a href="https://plus.google.com/115606090533118002214?rel=author">Carl Mehner</a></div>
    </div>
  </body>
</html>
`
...
<h3>Certificate Pin created for www.google.com</h3><p>Go to <tt>chrome://net-internals/#hsts</tt> to manually add it to your chrome install</p><p><b>sha1/PH28jUH5JV3EJIKi5wVf64OTZK4=</b></p><p>and/or add it to your <a href="http://en.wikipedia.org/wiki/HTTP_Strict_Transport_Security#Implementation">website's headers</a> using a method similar to HSTS (HTTP Strict Transport Security).<br />You <a href="http://tools.ietf.org/html/draft-ietf-websec-key-pinning#section-3.1">MUST</a> have a backup pin if you are using this method, otherwise, the browser will ignore the pin attempt.</p><p><b>Public-Key-Pins: max-age=31536000;<br />&emsp;pin-sha1="PH28jUH5JV3EJIKi5wVf64OTZK4=";<br />&emsp;pin-sha256="dhPKqMNshz05+vFbUc5C2HmcXReO04Fi+LtdzlydVD0=";</b></p>
<hr />
<p>
